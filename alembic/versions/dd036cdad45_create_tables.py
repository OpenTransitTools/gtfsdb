...
Revision ID: dd036cdad45
Revises: 1cbb6c31e044
Create Date: 2015-09-17 15:20:07.646727

"""

# revision identifiers, used by Alembic.
revision = 'dd036cdad45'
...
def upgrade():
    ...
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='MULTILINESTRING'), nullable=True),
    ...
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='LINESTRING', srid=900913), nullable=True),
    ...
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='POINT', srid=900913), nullable=True),
